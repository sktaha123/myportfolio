...
const Projects = () => {
  ...
  return (
    <div className="min-h-screen bg-primary-bg pt-20 pb-20 px-6">
      <div className="max-w-7xl mx-auto">

        {/* Header Section */}
        <div className="mb-8">
          <h1 className="font-heading text-5xl md:text-6xl font-bold text-black dark:text-white mb-6">
            My Projects
          </h1>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 sticky top-16 z-40 bg-white/95 dark:bg-zinc-950/95 backdrop-blur-md p-4 md:px-6 md:border border-y md:border-x border-gray-100 dark:border-zinc-800 -mx-6 md:mx-0 md:rounded-2xl transition-all duration-300">
